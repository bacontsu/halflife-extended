...
void CGameRules::RefreshSkillData ()
{
	...
	// Chumtoad
	gSkillData.chumHealth = GetSkillCvar("sk_chum_health");

	// Hassault
	gSkillData.hassaultHealth = GetSkillCvar("sk_hass_health");

	// Kingpin
	gSkillData.kpinHealth = GetSkillCvar("sk_kpin_health");
	gSkillData.kpinDmgTele = GetSkillCvar("sk_kpin_dmg_tele");
