...
#define CLASS_CHUMTOAD			16
#define CLASS_BLACKOPS			17
#define	CLASS_BARNACLE			18 // special because no one pays attention to it, and it eats a wide cross-section of creatures.
