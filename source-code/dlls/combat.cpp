...
void CGib::SpawnHeadGib(entvars_t* pevVictim)
{
	...
	if (FClassnameIs(pevVictim, "monster_human_grunt") || FClassnameIs(pevVictim, "monster_human_grunt_ally") || FClassnameIs(pevVictim, "monster_human_medic_ally") || FClassnameIs(pevVictim, "monster_human_torch_ally"))
	{
		pGib->Spawn("models/gibs/gib_hgrunt.mdl");// throw one leg, lol
		pGib->pev->body = 0;
	}
	else
	{
