...
cvar_t	sk_bigmomma_health_factor4 = {"sk_bigmomma_health_factor4","1.0"};
...
cvar_t	sk_bigmomma_dmg_slash4 = {"sk_bigmomma_dmg_slash4","50"};
...
cvar_t	sk_bigmomma_dmg_blast4 = {"sk_bigmomma_dmg_blast4","100"};
...
cvar_t	sk_bigmomma_radius_blast4 = {"sk_bigmomma_radius_blast4","250"};
...
cvar_t	sk_hgrunt_kick4 = {"sk_hgrunt_kick4","0"};
...
cvar_t	sk_hgrunt_pellets4 = {"sk_hgrunt_pellets4","0"};
...
cvar_t	sk_hgrunt_gspeed4 = {"sk_hgrunt_gspeed4","0"};
...
cvar_t	sk_ichthyosaur_shake4	= {"sk_ichthyosaur_shake4","0"};
...
cvar_t	sk_controller_dmgzap4 = {"sk_controller_dmgzap4","0"};
...
cvar_t	sk_controller_speedball4 = {"sk_controller_speedball4","0"};
...
cvar_t	sk_controller_dmgball4 = {"sk_controller_dmgball4","0"};
...
cvar_t	sk_nihilanth_zap4 = {"sk_nihilanth_zap4","0"};
...
cvar_t	sk_plr_crowbar4 = {"sk_plr_crowbar4","0"};
...
cvar_t	sk_plr_9mm_bullet4 = {"sk_plr_9mm_bullet4","0"};
...
cvar_t	sk_plr_357_bullet4 = {"sk_plr_357_bullet4","0"};
...
cvar_t	sk_plr_9mmAR_bullet4 = {"sk_plr_9mmAR_bullet4","0"};
...
cvar_t	sk_plr_9mmAR_grenade4 = {"sk_plr_9mmAR_grenade4","0"};
...
cvar_t	sk_plr_buckshot4 = {"sk_plr_buckshot4","0"};
...
cvar_t	sk_plr_xbow_bolt_client4 = {"sk_plr_xbow_bolt_client4","0"};
...
cvar_t	sk_plr_xbow_bolt_monster4 = {"sk_plr_xbow_bolt_monster4","0"};
...
cvar_t	sk_plr_rpg4 = {"sk_plr_rpg4","0"};
...
cvar_t	sk_plr_gauss4 = {"sk_plr_gauss4","0"};
...
cvar_t	sk_plr_hand_grenade4 = {"sk_plr_hand_grenade4","0"};
...
cvar_t	sk_plr_satchel4	= {"sk_plr_satchel4","0"};
...
cvar_t	sk_plr_tripmine4 = {"sk_plr_tripmine4","0"};
...
cvar_t	sk_plr_hornet_dmg4 = {"sk_plr_hornet_dmg4","0"};
// Pipe Wrench
...
cvar_t	sk_12mm_bullet4 = {"sk_12mm_bullet4","0"};
...
cvar_t	sk_healthcharger4	= { "sk_healthcharger4","0" };
...
cvar_t	sk_monster_head4	= { "sk_monster_head4","2" };
...
cvar_t	sk_monster_chest4	= { "sk_monster_chest4","1" };
...
cvar_t	sk_player_head4	= { "sk_player_head4","2" };
...
cvar_t	sk_player_chest4	= { "sk_player_chest4","1" };
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER ( &sk_agrunt_health4 );// {"sk_agrunt_health4","0"};
	...
	CVAR_REGISTER ( &sk_agrunt_dmg_punch4 );// {"sk_agrunt_dmg_punch4","0"};
	...
	CVAR_REGISTER ( &sk_apache_health4 );// {"sk_apache_health4","0"};
	...
	CVAR_REGISTER ( &sk_barney_health4 );// {"sk_barney_health4","0"};
	...
	CVAR_REGISTER ( &sk_bullsquid_health4 );// {"sk_bullsquid_health4","0"};
	...
	CVAR_REGISTER ( &sk_bullsquid_dmg_bite4 );// {"sk_bullsquid_dmg_bite4","0"};
	...
	CVAR_REGISTER ( &sk_bullsquid_dmg_whip4 );// {"sk_bullsquid_dmg_whip4","0"};
	...
	CVAR_REGISTER ( &sk_bullsquid_dmg_spit4 );// {"sk_bullsquid_dmg_spit4","0"};
	...
	CVAR_REGISTER ( &sk_bigmomma_health_factor4 );// {"sk_bigmomma_health_factor4","1.0"};
	...
	CVAR_REGISTER ( &sk_bigmomma_dmg_slash4 );// {"sk_bigmomma_dmg_slash4","50"};
	...
	CVAR_REGISTER ( &sk_bigmomma_dmg_blast4 );// {"sk_bigmomma_dmg_blast4","100"};
	...
	CVAR_REGISTER ( &sk_bigmomma_radius_blast4 );// {"sk_bigmomma_radius_blast4","250"};
	...
	CVAR_REGISTER ( &sk_gargantua_health4 );// {"sk_gargantua_health4","0"};
	...
	CVAR_REGISTER ( &sk_gargantua_dmg_slash4 );// {"sk_gargantua_dmg_slash4","0"};
	...
	CVAR_REGISTER ( &sk_gargantua_dmg_fire4 );// {"sk_gargantua_dmg_fire4","0"};
	...
	CVAR_REGISTER ( &sk_gargantua_dmg_stomp4	);// {"sk_gargantua_dmg_stomp4","0"};
	...
	CVAR_REGISTER ( &sk_hassassin_health4 );// {"sk_hassassin_health4","0"};
	...
	CVAR_REGISTER ( &sk_headcrab_health4 );// {"sk_headcrab_health4","0"};
	...
	CVAR_REGISTER ( &sk_headcrab_dmg_bite4 );// {"sk_headcrab_dmg_bite4","0"};
	...
	CVAR_REGISTER ( &sk_hgrunt_health4 );// {"sk_hgrunt_health4","0"};
	...
	CVAR_REGISTER ( &sk_houndeye_health4 );// {"sk_houndeye_health4","0"};
	...
	CVAR_REGISTER ( &sk_houndeye_dmg_blast4 );// {"sk_houndeye_dmg_blast4","0"};
	...
	CVAR_REGISTER ( &sk_islave_health4 );// {"sk_islave_health4","0"};
	...
	CVAR_REGISTER ( &sk_islave_dmg_claw4 );// {"sk_islave_dmg_claw4","0"};
	...
	CVAR_REGISTER ( &sk_islave_dmg_clawrake4	);// {"sk_islave_dmg_clawrake4","0"};
	...
	CVAR_REGISTER ( &sk_islave_dmg_zap4 );// {"sk_islave_dmg_zap4","0"};
	...
	CVAR_REGISTER ( &sk_ichthyosaur_health4	);// {"sk_ichthyosaur_health4","0"};
	...
	CVAR_REGISTER ( &sk_ichthyosaur_shake4	);// {"sk_ichthyosaur_health4","0"};
	...
	CVAR_REGISTER ( &sk_leech_health4 );// {"sk_leech_health4","0"};
	...
	CVAR_REGISTER ( &sk_leech_dmg_bite4 );// {"sk_leech_dmg_bite4","0"};
	...
	CVAR_REGISTER ( &sk_scientist_health4 );// {"sk_scientist_health4","0"};
	...
	CVAR_REGISTER ( &sk_snark_health4 );// {"sk_snark_health4","0"};
	...
	CVAR_REGISTER ( &sk_snark_dmg_bite4 );// {"sk_snark_dmg_bite4","0"};
	...
	CVAR_REGISTER ( &sk_snark_dmg_pop4 );// {"sk_snark_dmg_pop4","0"};
	...
	CVAR_REGISTER ( &sk_zombie_health4 );// {"sk_zombie_health4","0"};
	...
	CVAR_REGISTER ( &sk_zombie_dmg_one_slash4 );// {"sk_zombie_dmg_one_slash4","0"};
	...
	CVAR_REGISTER ( &sk_zombie_dmg_both_slash4 );// {"sk_zombie_dmg_both_slash4","0"};
	...
	CVAR_REGISTER ( &sk_turret_health4 );// {"sk_turret_health4","0"};
	...
	CVAR_REGISTER ( &sk_miniturret_health4 );// {"sk_miniturret_health4","0"};
	...
	CVAR_REGISTER ( &sk_sentry_health4 );// {"sk_sentry_health4","0"};
	...
	//Chumtoad
	REGISTER_SKILL_CVARS(chum_health);

	//Hassault
	REGISTER_SKILL_CVARS(hass_health);

	//Kingpin
	REGISTER_SKILL_CVARS(kpin_health);
	REGISTER_SKILL_CVARS(kpin_dmg_tele);
	...
	CVAR_REGISTER ( &sk_plr_crowbar4 );// {"sk_plr_crowbar4","0"};
	...
	CVAR_REGISTER ( &sk_plr_9mm_bullet4 );// {"sk_plr_9mm_bullet4","0"};
	...
	CVAR_REGISTER ( &sk_plr_357_bullet4 );// {"sk_plr_357_bullet4","0"};
	...
	CVAR_REGISTER ( &sk_plr_9mmAR_bullet4 );// {"sk_plr_9mmAR_bullet4","0"};
	...
	CVAR_REGISTER ( &sk_plr_9mmAR_grenade4 );// {"sk_plr_9mmAR_grenade4","0"};
	...
	CVAR_REGISTER ( &sk_plr_buckshot4 );// {"sk_plr_buckshot4","0"};
	...
	CVAR_REGISTER ( &sk_plr_xbow_bolt_monster4 );// {"sk_plr_xbow_bolt4","0"};
	...
	CVAR_REGISTER ( &sk_plr_xbow_bolt_client4 );// {"sk_plr_xbow_bolt4","0"};
	...
	CVAR_REGISTER ( &sk_plr_rpg4 );// {"sk_plr_rpg4","0"};
	...
	CVAR_REGISTER ( &sk_plr_gauss4 );// {"sk_plr_gauss4","0"};
	...
	CVAR_REGISTER ( &sk_plr_egon_narrow4 );// {"sk_plr_egon_narrow4","0"};
	...
	CVAR_REGISTER ( &sk_plr_egon_wide4 );// {"sk_plr_egon_wide4","0"};
	...
	CVAR_REGISTER ( &sk_plr_hand_grenade4 );// {"sk_plr_hand_grenade4","0"};
	...
	CVAR_REGISTER ( &sk_plr_satchel4 );// {"sk_plr_satchel4","0"};
	...
	CVAR_REGISTER ( &sk_plr_tripmine4 );// {"sk_plr_tripmine4","0"};
	...
	CVAR_REGISTER(&sk_plr_hornet_dmg4);// {"sk_plr_hornet_dmg4","0"};
	...
	CVAR_REGISTER ( &sk_12mm_bullet4 );// {"sk_12mm_bullet4","0"};
	...
	CVAR_REGISTER ( &sk_9mmAR_bullet4 );// {"sk_9mm_bullet1","0"};
	...
	CVAR_REGISTER ( &sk_9mm_bullet4 );// {"sk_9mm_bullet4","0"};
	...
	CVAR_REGISTER ( &sk_healthcharger4 );
