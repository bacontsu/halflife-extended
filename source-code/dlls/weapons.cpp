...
void DecalGunshot(TraceResult* pTrace, int iBulletType)
{
	...
	if (VARS(pTrace->pHit)->solid == SOLID_BSP || VARS(pTrace->pHit)->movetype == MOVETYPE_PUSHSTEP)
	{
		...
		case BULLET_MONSTER_9MM:
			UTIL_GunshotDecalTrace(pTrace, DamageDecal(pEntity, DMG_BULLET | DMG_NEVERGIB));
			break;
...
void W_Precache()
{
	...
	UTIL_PrecacheOther("ammo_isotope_box");
#endif
	...
	UTIL_PrecacheOther("ammo_handgrenade_box");
	...
	// chummy
	UTIL_PrecacheOtherWeapon("weapon_chummy");

	// baton
	//UTIL_PrecacheOtherWeapon("weapon_baton");

	// beretta
	//UTIL_PrecacheOtherWeapon("weapon_beretta");

	// 556 AR
	UTIL_PrecacheOtherWeapon("weapon_assaultrifle");
...
TYPEDESCRIPTION	CBasePlayerWeapon::m_SaveData[] =
{
	...
	DEFINE_FIELD(CBasePlayerWeapon, m_Activity, FIELD_INTEGER),
...
void CBasePlayerWeapon::SetActivity(Activity act)
{
...
//=======================================================================
// Materialize - make a CBasePlayerWeapon visible, tangible and animated
//=======================================================================
void CBasePlayerWeapon::Materialize()
{
	...
	UTIL_SetOrigin(pev, pev->origin);// link into world.
	SetTouch(&CBasePlayerItem::DefaultTouch);
	SetThink(&CBasePlayerWeapon::Think);

}

//Keep thinking and animating
void CBasePlayerWeapon::Think()
{
	StudioFrameAdvance();
	pev->nextthink = gpGlobals->time + 0.1;

	CBasePlayerItem::Think();
}
...
TYPEDESCRIPTION	CRpg::m_SaveData[] =
{
	...
	DEFINE_FIELD(CRpg, nextAnimUpdate, FIELD_FLOAT),
};
