...
Moves existing objects, deletes them when needed
and creates new ones if the rain is still active
...
void ProcessRain(void)
{
    ...
    while(rain_nextspawntime < rain_curtime)
    {
              ...
              
          {
              ...
              newClDrip->alpha = gEngfuncs.pfnRandomFloat(0.4, 0.5);
...
Deletes expired FX objects

Called every frame before ProcessRain
...
Frees memory by deleting all the objects
