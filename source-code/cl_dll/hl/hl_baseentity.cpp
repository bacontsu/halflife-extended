...
int gmsgViewmodelSkin = 0; //added by bacontsu made by FranticDreamer
int gmsgSetSkin = 0;
...
CGrenade *CGrenade::ShootBouncy( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time){ return 0; }
