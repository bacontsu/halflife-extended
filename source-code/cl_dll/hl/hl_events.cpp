...
void Game_HookEvents()
{
	...
	gEngfuncs.pfnHookEvent("events/chumtoadfire.sc", EV_FireChumtoad);
	//gEngfuncs.pfnHookEvent("events/ber1.sc", EV_FireBeretta1);
	//gEngfuncs.pfnHookEvent("events/ber2.sc", EV_FireBeretta2);
	//gEngfuncs.pfnHookEvent("events/baton.sc", EV_Baton);
	gEngfuncs.pfnHookEvent("events/ar1.sc", EV_ar1);
