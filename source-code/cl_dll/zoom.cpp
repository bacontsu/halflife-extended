...
{
	m_hBottom_Left = SPR_Load("sprites/sniper_bottom_left.spr");
	m_hBottom_Right = SPR_Load("sprites/sniper_bottom_right.spr");
	m_hTop_Left = SPR_Load("sprites/sniper_top_left.spr");
	m_hTop_Right = SPR_Load("sprites/sniper_top_right.spr");
	m_hBlack = SPR_Load("sprites/sniper_black.spr");
	m_iHudMode = 0;
	return 1;
}
